...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '1920x1080x30', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '848x480x60', 'description': 'depth stream profile'},
                           {'name': 'depth_module.depth_format',    'default': 'Z16', 'description': 'depth stream format'},
                           {'name': 'depth_module.infra_profile',   'default': '1280x720x30', 'description': 'infra streams (0/1/2) profile'},
